...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/IlhamStore23/permission/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/IlhamStore23/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/IlhamStore23/permission/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
wget -q -O /etc/pam.d/common-password "https://raw.githubusercontent.com/IlhamStore23/kucing/main/tools/password"
...
wget -q -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/IlhamStore23/kucing/main/tools/ws-dropbear"
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/IlhamStore23/kucing/main/tools/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/IlhamStore23/kucing/main/tools/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://raw.githubusercontent.com/IlhamStore23/kucing/main/tools/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/IlhamStore23/kucing/main/tools/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/IlhamStore23/kucing/main/issue.net"
